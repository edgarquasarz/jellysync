...
export function createMockWindowApi(overrides?: Partial<MockWindowApi>): MockWindowApi {
  const defaultApi: MockWindowApi = {
    ...
    startSync2: () =>
      Promise.resolve({ success: true, tracksCopied: 0, tracksFailed: [], errors: [] }),
...
export function createMockWindowApiForUseDeviceSelections(
  overrides?: Partial<MockWindowApi>,
): MockWindowApi {
